...
def test_tls_sni():
    res = execute_query_https("SELECT 1 settings log_queries=1;", user="john", cert_name="client1")
    res = execute_query_https("SYSTEM FLUSH LOGS;", user="john", cert_name="client1")
    time.sleep(1)
